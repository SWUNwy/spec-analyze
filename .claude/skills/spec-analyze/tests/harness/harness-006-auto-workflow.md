...
expected_behavior: Initialize or resume the workflow controller, invoke plan-authoring, stop for explicit execution approval, then invoke plan-execution and completion-verification in order.
